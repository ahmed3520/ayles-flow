...
### Category 7: Next.js Image Anti-Patterns

#### Anti-Pattern 7.1: Using External URLs Without Config

**❌ WRONG - External image URL without configuration:**
```typescript
...
export default function Avatar() {
  return (
    <Image
      src="https://example.com/avatar.jpg"  // This will ERROR!
      alt="User avatar"
      width={100}
      height={100}
    />
...
**Error you'll see:**
```
Error: Invalid src prop (https://example.com/avatar.jpg) on `next/image`, 
hostname "example.com" is not configured under images in your `next.config.js`
```

**✅ CORRECT - Add domain to next.config.js:**
```typescript
// next.config.ts
...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: '*.supabase.co',  // Wildcard for subdomains
      },
      {
        protocol: 'https',
...
remotePatterns: [
  ...
  { protocol: 'https', hostname: 'cdn.shopify.com' },     // Shopify
...
#### Anti-Pattern 7.2: Using <img> Instead of next/image
...
#### Anti-Pattern 7.3: Missing width/height or fill Prop

**❌ WRONG - No dimensions:**
```typescript
<Image src="/hero.jpg" alt="Hero" />  // Error: missing width/height
```

**✅ CORRECT - Option 1: Explicit dimensions:**
```typescript
<Image src="/hero.jpg" alt="Hero" width={1200} height={600} />
```

**✅ CORRECT - Option 2: Fill mode (for responsive):**
```typescript
...
**Note:** When using `fill`, the parent must have `position: relative` and defined dimensions.
